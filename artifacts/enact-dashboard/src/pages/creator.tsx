...
const PAGE_CONFIGS = [
  {
    ...
    fields: [
      ...
      { key: "hero_tagline",    label: "Підзаголовок",       type: "textarea", default: "Суверенний AI-страж TON блокчейну — самосканує, саморемонтується, самонавчається" },
      { key: "hero_badge",      label: "Бейдж статусу",      type: "text",     default: "ACTIVE · SELF-LEARNING" },
      { key: "hero_cta",        label: "CTA кнопка",         type: "text",     default: "УВІЙТИ В СИСТЕМУ" },
      { key: "cycle_info",      label: "Опис циклів",        type: "textarea", default: "Автономні цикли TITAN-94 постійно захищають блокчейн TON 24/7" },
    ],
  },
  {
    id: "about",
    ...
    fields: [
      ...
      { key: "about_subtitle",  label: "Підзаголовок",       type: "text",     default: "Перший автономний AI-організм" },
      { key: "about_body",      label: "Основний текст",     type: "textarea", default: "TITAN-94 — перший автономний AI-організм на блокчейні TON. Скановує кожен блок, виявляє вразливості та самовідновлюється без участі людини." },
      { key: "about_vision",    label: "Наша візія",         type: "textarea", default: "Побудувати першу суверенну AI-імунну систему для Web3, яка захищає блокчейн 24/7 без участі команди." },
      { key: "about_contacts",  label: "Контакти / соц. мережі", type: "text", default: "@TITAN94_BOT · t.me/titan94_ai" },
    ],
  },
  {
    id: "earn",
    ...
    fields: [
      ...
      { key: "dev_price",       label: "Ціна DEVELOPER (TON)",type: "text",    default: "50" },
      { key: "ref_reward",      label: "Реферальний бонус (TON)", type: "text",default: "0.1" },
      { key: "ref_percent",     label: "Відсоток реферала (%)",type: "text",   default: "15" },
      { key: "min_withdraw",    label: "Мінімум виводу (TON)",type: "text",    default: "0.5" },
      { key: "earn_headline",   label: "Заголовок розділу",  type: "text",     default: "АВТО-ЗАРОБІТОК ВІД TITAN-94" },
    ],
  },
  {
    id: "threats",
    label: "Загрози (Threats)",
    icon: "🔴",
    apiKey: "page_threats",
    fields: [
      { key: "threats_title",   label: "Заголовок",          type: "text",     default: "THREATS MATRIX" },
      { key: "threats_sub",     label: "Підзаголовок",       type: "textarea", default: "Реальний час — TITAN-94 сканує кожен новий блок TON на наявність вразливостей" },
      { key: "scan_interval",   label: "Інтервал сканування (хв)", type: "text",default: "3" },
      { key: "heal_interval",   label: "Інтервал лікування (хв)", type: "text", default: "5" },
    ],
  },
  {
    id: "status",
    ...
    apiKey: "page_status",
    fields: [
      { key: "status_title",    label: "Заголовок",          type: "text",     default: "AGENT STATUS" },
      { key: "status_subtitle", label: "Підзаголовок",       type: "textarea", default: "Реальний час роботи чотирьох автономних циклів TITAN-94" },
      { key: "agent_name",      label: "Назва агента",       type: "text",     default: "TITAN-94 OMEGA" },
      { key: "agent_version",   label: "Версія агента",      type: "text",     default: "v4.2.1" },
    ],
  },
  {
    id: "access",
    ...
    apiKey: "page_access",
    fields: [
      { key: "access_title",    label: "Заголовок",          type: "text",     default: "ТАРИФИ ДОСТУПУ" },
      { key: "free_desc",       label: "Опис FREE",          type: "textarea", default: "Базовий моніторинг, 50 сканувань/день, без авто-хілу" },
      { key: "pro_desc",        label: "Опис PRO",           type: "textarea", default: "Повний доступ, 500 сканувань/день, авто-хіл, AI аналіз" },
      { key: "elite_desc",      label: "Опис ELITE",         type: "textarea", default: "Необмежений доступ, пріоритетні хіли, NEXUS AI, Telegram alerts" },
      { key: "dev_desc",        label: "Опис DEVELOPER",     type: "textarea", default: "API доступ, 10 000 req/день, веб-хуки, white-label" },
    ],
  },
  {
    id: "grant",
    ...
    fields: [
      ...
      { key: "grant_desc",      label: "Опис гранту",        type: "textarea", default: "Заявка на грант TON Foundation для розвитку TITAN-94 як інфраструктурного проекту TON блокчейну." },
      { key: "grant_amount",    label: "Запитувана сума",    type: "text",     default: "50 000 USDT" },
      { key: "grant_milestone", label: "Ключові міailstones",type: "textarea", default: "M1: Аудит контрактів. M2: AI інтеграція. M3: Mainnet. M4: DAO." },
    ],
  },
  {
    id: "seo",
    ...
    apiKey: "page_seo",
    fields: [
      { key: "meta_title",      label: "Title (< 60 символів)",   type: "text",     default: "TITAN-94 — AI Security Guard for TON Blockchain" },
      { key: "meta_desc",       label: "Description (< 160 симв)",type: "textarea", default: "Autonomous AI organism that scans, heals and learns on TON blockchain 24/7. Real-time protection. Self-healing protocol." },
      { key: "og_image",        label: "OG Image URL",            type: "text",     default: "https://titan94.ai/og-image.jpg" },
      { key: "og_site",         label: "OG Site Name",            type: "text",     default: "TITAN-94 AI" },
    ],
  },
];
