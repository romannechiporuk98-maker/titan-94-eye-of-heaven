...
export const getGetJobQueryKey = (address: string) => {
  return [`/api/jobs/${address}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getJob>>> = ({
    signal,
  }) => getJob(address, { signal, ...requestOptions });
...
export const getCreateJobLinkMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
...
export type CreateJobLinkMutationResult = NonNullable<
  Awaited<ReturnType<typeof createJobLink>>
>;
